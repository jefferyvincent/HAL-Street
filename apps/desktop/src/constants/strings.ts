  ...
  return {
    ...
    committee: {
      ...
      live: {
        ...
        on: (underlying: string) => t("committee.live.on", { underlying }),
        done: t("committee.live.done"),
        running: t("committee.live.running"),
        pending: t("committee.live.pending"),
        catalyst: t("committee.live.catalyst"),
        debate: t("committee.live.debate"),
        judge: t("committee.live.judge"),
        read: (lean: string, value: string) => t("committee.live.read", { lean, value }),
        readFailed: (error: string) => t("committee.live.readFailed", { error }),
